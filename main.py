...
import os
from api import get_app_credentials, report_videos, reset_downloads, show_all_playlists
...
if __name__ == '__main__':
    ...
    print 'commencing...\n\n'
    #PLAYLIST_TITLES = ['Actualized', 'Mounir-Al-Khabbaz', 'Eckhart Tolle', 'Khakani', 'Leo-Awakening', 'osho', 'rock-love-songs', 'Slow-Music']
    ...
    for playlist_title in PLAYLIST_TITLES:    
        ...
        download_playlist_audio(videos, target_path, AUDIO_QUALITY, USE_ORDINAL_NUMBERS)
